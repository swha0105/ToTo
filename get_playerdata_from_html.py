...
tmp_file = '/home/swha/ToTo/ToTo/Data/soup/picther_soup_data/차우찬_1987-05-31_2017'
...
featureName = ['상대','결과','선발','이닝','실점','자책','타자','타수','안타'\
    ,'2타','3타','홈런','볼넷','고4','사구','삼진','투구','WHIP','타율','출루율'\
    ,'OPS','ERA','avLI','RE24','WPA','GSC','DEC','간격']
feature = []

for n,table in enumerate(pitcher_table.find_all('tr')):
